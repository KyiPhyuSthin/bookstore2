...
@section('body-content')
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between mb-6">
            ...
            data-twe-toggle="modal" data-twe-target="#addModal">
                Add
            </button>
        </div>
                        ...
                        <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                            ...
                            <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
                                <div class="flex items-center gap-2">
                                    ...
                                    id="edit-btn" data-id="{{ $subCategory->id }}" data-name="{{ $subCategory->name }}" data-twe-toggle="modal" data-twe-target="#editModal">
                                        Edit
                                    </button>
                                    <button class="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-9 rounded-md px-3"
                                    id="delete-btn" data-delete-id="{{ $subCategory->id }}" data-twe-toggle="modal" data-twe-target="#deleteModal" color="red" color="red">
                                        Delete
                                    </button>
                                </div>
                            </td>
            ...
            <div
                ...
                <div class="relative flex-auto p-4" data-twe-modal-body-ref>
                    <form id="add-form" action="/management/sub_categories" method="POST">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Enter sub category name" id="add-name" name="name" class="flex h-10 w-1/2 rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
                        </div>

                        <div class="bg-white mb-0 w-[50%] my-2 text-sm inline-block">
                            <label for="" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300"> Category </label>
                ...
                <div
                    ...
                    <button type="button"
                        ...
                        data-twe-ripple-init data-twe-ripple-color="light" id="confirm-add-btn">
                        Create
                    </button>
                </div>
            </div>
        ...
        <div data-twe-modal-dialog-ref
            ...
            <div
                ...
                <div class="relative flex-auto p-4" data-twe-modal-body-ref>
                    <form id="edit-form" method="POST">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Enter sub category name" id="edit-name" name="name" class="flex h-10 w-1/2 rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
                        </div>
                ...
                <div
                    ...
                    <button type="button"
                        class="ms-1 inline-block rounded bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
                        data-twe-ripple-init data-twe-ripple-color="light" id="confirm-edit-btn">
                        Save changes
                    </button>
                </div>
            </div>
            ...
            <div
                ...
                <div
                    ...
                    <button type="button"
                        ...
                        data-twe-ripple-init data-twe-ripple-color="light" id="confirm-delete-btn">
                        Confirm Delete
                    </button>
                </div>
            </div>
