                        ...
                        <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                            ...
                            <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
                                <div class="flex items-center gap-2">
                                    ...
                                    id="edit-btn" data-id="{{ $category->id }}" data-name="{{ $category->name }}" data-twe-toggle="modal" data-twe-target="#editModal">
                                        Edit
                                    </button>
                                    <button class="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-9 rounded-md px-3"
                ...
                <div class="relative flex-auto p-4" data-twe-modal-body-ref>
                    <form id="add-form" action="/management/genres" method="POST">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Enter genre name" id="add-name" name="name" class="flex h-10 w-1/2 rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
                        </div>
                    </form>
                </div>
                ...
                <div class="relative flex-auto p-4" data-twe-modal-body-ref>
                    <form id="edit-form" method="POST">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Enter genre name" id="edit-name" name="name" class="flex h-10 w-1/2 rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
                        </div>
                    </form>
                </div>
